...
4. Abrir el PR contra `main`, completar la plantilla, incluir `Closes #N` y solicitar revisión a `@DesarrolloS2026UTNFRCU-grupoxx/reviewers`.
...
`https://github.com/DesarrolloS2026UTNFRCU-grupoxx/SmartPantry/compare/main...feature/<numero-issue>-<descripcion-corta>?expand=1`
